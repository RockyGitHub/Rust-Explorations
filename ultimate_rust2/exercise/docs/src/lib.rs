...
pub struct Pumpkin {
    ...
    pub roundness: f32,
    /// `orangeness` is a number between 8 to 27
    pub orangeness: i32,
}
...
impl Pumpkin {
    /// If you smash the pie, you can't use it for a pie!
    pub fn smash(self) {}
}
...
/// BURNT_ORANGE is for the orangeness field in the [Pumpkin struct](Pumpkin)
